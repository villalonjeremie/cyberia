...
class LogUploadController extends AbstractController
{
    ...
    public function upload(Request $request): JsonResponse
    {
        $file = $request->files->get('file');
                ...
                // Affiche le nom original du fichier
        error_log("Received file: " . $file->getClientOriginalName());

        // Affiche le path temporaire côté PHP
        error_log("File temporary path: " . $file->getPathname());
        error_log("File temporary path: " . $file->getFileName());
